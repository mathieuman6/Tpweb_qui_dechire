...
<div class="box">
  <div class="columns is-mobile is-centered">
    <div class="column is-narrow">
          <form role="form" method="post" action="../../../../Tpweb_qui_dechire-master/new_insert_ingredients">
            ...
            <div class="field" id="ingredients">
              <div class="control list_ingredients">
                <input name="ingredient0" class="input options" type="text" placeholder="Nom de l'ingrédient">
              </div>
            </div>
